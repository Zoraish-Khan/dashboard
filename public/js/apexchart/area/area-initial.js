...
var options = {
  ...
  var chart = new ApexCharts(document.querySelector("#chart-spline"), options);
  chart.render();
  // spline end
...
var options = {
  ...
  var chartYears = new ApexCharts(document.querySelector("#chart-github"), optionsYears);
  chartYears.render();
  // github style end

  //stacked start
// time genrate for stacked
...
var ts1 = 1388534400000;
    ...
    var options = {
      ...
      var chart = new ApexCharts(document.querySelector("#chart-irregular"), options);
      chart.render();
      // end irregular js
      ...
      var chart = new ApexCharts(document.querySelector("#chart-missing-data"), options);
      chart.render();
    // missing nul end
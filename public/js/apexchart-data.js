...
options = {
    ...
    series: [{
        ...
        name: "Active Project",
        type: "line",
        data: [44, 55, 41, 67, 22, 43, 71, 41, 36, 27, 43]
    }, {
        name: "Revenue",
        type: "area",
        data: [30, 25, 36, 30, 45, 35, 64, 52, 59, 36, 39]
...
const project_chart = document.querySelector("#project-chart");
if (project_chart) {
    (chart = new ApexCharts(project_chart, options)).render();
}
...
const donut_chart = document.querySelector("#donut-chart");
if (donut_chart) {
    (chart = new ApexCharts(donut_chart, options)).render();
}